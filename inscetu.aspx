...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="nom_inscetu" runat="server" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Text="Prénom de l'étudiant"></asp:Label>
        <br />
        <asp:TextBox ID="prenom_inscetu" runat="server" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label3" runat="server" Text="E-mail"></asp:Label>
        <br />
        <asp:TextBox ID="mail_inscetu" runat="server" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label4" runat="server" Text="Numéro de Téléphone "></asp:Label>
        <br />
        <asp:TextBox ID="phone_inscetu" runat="server" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label5" runat="server" Text="N° Étudiant"></asp:Label>
        <br />
        <asp:TextBox ID="no_inscetu" runat="server" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        ...
        <br />
        <asp:TextBox ID="ad_inscetu" runat="server" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        ...
        <br />
        <asp:TextBox ID="username_inscetu" runat="server" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label10" runat="server" Text="Mot de passe"></asp:Label>
        <br />
        <asp:TextBox ID="pass_inscetu" runat="server" TextMode="Password" CssClass="inpuT"></asp:TextBox>
        <br />
        <br />
        <asp:Button ID="submit_inscetu" runat="server" OnClick="submit_inscetu_Click" Text="Valider" />
        <br />
        <br />
        <br />
        <br />
